    ...
    private function getMenu(){
        switch ($_SESSION['NIVEL']){
            case ADMINISTRADOR:
                ...
                break;
            case PROFESSOR:
                $_SESSION['MENU'] ='[{"nome":"Minhas Turmas","link":"TurmasSubmenu","icone":"glyphicon-bell","submenu":[{"nome":"ver","link":"?pag=Minhas-Turmas"},{"nome":"Nova Turma","link":"?pag=Cad.Turma"}]},{"nome":"Alunos","link":"AlunosSubmenu","icone":"glyphicon-education","submenu":[{"nome":"Presença","link":"?pag=Alunos"}]}]';
                break;
            case ALUNO:
